...
-- =============================================
create PROCEDURE spDelStandardPrimary
...
BEGIN
	...
	select @SAPCodeDigit=SAPCodeDigit,@Code=Code from 
	(SELECT t3.Value,[1] as SAPCodeDigit,[2] as Code
	FROM @tbl as t1
	...
	Delete StandardPrimary Where SAPCodeDigit=@SAPCodeDigit and Code=@Code
END
go
