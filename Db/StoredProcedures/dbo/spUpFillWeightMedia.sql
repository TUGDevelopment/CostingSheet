...
-- =============================================
create PROCEDURE spUpFillWeightMedia
	-- Add the parameters for the stored procedure here
	@ID nvarchar(max),
	@Name nvarchar(max),
	@GroupDescription nvarchar(max),
	@CodeName nvarchar(max),
	@MediaWeight nvarchar(max),
	@Unit nvarchar(max)
AS
BEGIN
	...
	Update StdFillWeightMedia set Name=@Name,GroupDescription=@GroupDescription,CodeName=@CodeName,MediaWeight=@MediaWeight,Unit=@Unit 
	Where SAPCodeDigit=@SAPCodeDigit and Code=@Code and GroupType=@GroupType
END
go
