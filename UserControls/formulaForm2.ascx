<%@ Control Language="C#" AutoEventWireup="true" CodeFile="formulaForm2.ascx.cs" Inherits="UserControls_test" %>
                         ...
                         <%--<dx:ASPxMenu ID="ASPxMenu1" runat="server" CssClass="ActionMenu" SeparatorWidth="0">
                            ...
                            <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="true" OnDataBinding="grid_DataBinding"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn FieldName="Component" GroupIndex="0">
                                    ...
                                    <dx:GridViewDataButtonEditColumn FieldName="Material" UnboundType="String">
                                            <PropertiesButtonEdit>
                                                ...
                                                <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('Matformu'); }" />
                                            </PropertiesButtonEdit>
                                ...
                                <%--<Templates>
                                    <DetailRow>
                                        <dx:ASPxGridView ID="detail" runat="server" AutoGenerateColumns="False" KeyFieldName="Id" Width="100%" OnBeforePerformDataSelect="detail_BeforePerformDataSelect">
						                    <Columns>
                                                <dx:GridViewCommandColumn ShowNewButton="true" ShowEditButton="true" VisibleIndex="0" ButtonRenderMode="Image" Width="45">
                                                    <CustomButtons>
							                    ...
							                    <dx:GridViewDataTextColumn FieldName="Yield" VisibleIndex="3" />
						                    </Columns>
