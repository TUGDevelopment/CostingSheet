...
<script type="text/javascript">
    ...
    function OnIDChanged(s) {
        ...
        formLayout.GetItemByName("Assignee").SetVisible(s.GetValue().toString() == "5" || s.GetValue().toString() == "3");
    ...
    function OnValueChanged(evt) {
        ...
        switch (evt) {
            case "RawMaterial":
                ClientRawMaterial1.SetText(ClientRawMaterial.GetText());
                break;
            case "Topping":
                ClientTopping1.SetText(ClientTopping.GetText());
                break;
            case "SizeMedia":
                ClientSizeMedia1.SetText(ClientSizeMedia.GetText());
                break;
            case "ContainerLid":
                ClientContainerLid1.SetText(ClientContainerLid.GetText());
                break;
            case "Grade":
                ClientGrade1.SetText(ClientGrade.GetText());
                break;
            default:
                break;
        }
    ...
    function OnBtnShowLink(evt) {
        var ID = hfCostID.Get("CostID");
        ClientgridData.GetValuesOnCustomCallback(["GetData", ID, 1].join("|"), function (r) {
            if (!r)
                return;
            var url = "./Default.aspx?viewMode=CustomerEditForm&ID=" + r["TRFID"] + "&form=EditDraft&UserType=" + + r["utype"];
    ...
    function HidePopupAndShowInfo(closedBy, returnValue) {
        ...
        if (closedBy == 'TransRawMaterial' || closedBy == 'Topping' || closedBy == 'ContainerLid' || closedBy == 'SizeMedia' || closedBy == 'Grade') {
            pcassign.Hide();
            ClientgridData.GetValuesOnCustomCallback(["GetFilteringData", closedBy, returnValue, "code"].join('|'), OnGetValuesOnCustomCallbackComplete);
        }
    ...
    function OnButtonClick(evt) {
        var url;
        url = 'popupControls/selmaster.aspx?view=' + evt + "&group=" + ClientProductGroup.GetValue();
        //else
    ...
    function OnGetValuesOnCustomCallbackComplete(values) {
        if (!values)
            return;
        debugger;
        if (values["View"] == "Grade") {
            ClientGrade1.SetValue(values["Code"] + "; " + values["Description"]);
            ClientGrade.SetValue(values["Code"]);
            OnValueChanged('Grade');
        }
        else if (values["View"] == "SizeMedia") {
            ClientSizeMedia1.SetValue([values["Code"], values["CanSize"], values["Type"], values["Media"], values["NW"], values["NutritionType"]].join("; "));
            ClientSizeMedia.SetValue(values["Code"]);
            OnValueChanged('SizeMedia');
        }
        else if (values["View"] == "ContainerLid") {
            ClientContainerLid1.SetValue([values["Code"], values["ContainerType"], values["LidType"]].join("; "));
            ClientContainerLid.SetValue(values["Code"]);
            OnValueChanged('ContainerLid');
        }
        else if (values["View"] == "Topping") {
            ClientTopping1.SetValue(values["Code"] + "; " + values["Description"]);
            ClientTopping.SetValue(values["Code"]);
            OnValueChanged('Topping');
        }
        else if (values["View"] == "TransRawMaterial") {
            ClientRawMaterial1.SetValue(values["Code"] + "; " + values["Description"]);
            ClientRawMaterial.SetValue(values["Code"]);
            OnValueChanged('RawMaterial');
        }
    }
</script>
...
<dx:ASPxGridView runat="server" ID="gridData" KeyFieldName="ID" ClientInstanceName="ClientgridData" Width="100%" DataSourceID="dsgv" 
                        ...
                        <dx:LayoutItem Caption="Technical No" VerticalAlign="Middle">
                            ...
                            <LayoutItemNestedControlCollection>
                                ...
                                <dx:aspxbuttonedit runat="server" ID="CmbTechnicalNo" ClientInstanceName="ClientTechnicalNo">
                                    ...
                                    <clientsideevents buttonclick="function(s, e) { OnBtnShowLink('link'); }" />
                                </dx:aspxbuttonedit>
                    ...
                    <Items>
                        <dx:LayoutItem Caption="Product Group" VerticalAlign="Middle">
                           ...
                           <dx:LayoutItem Caption="Species+catch method+cert">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbRawMaterial" ClientInstanceName="ClientRawMaterial" OnCallback="cmbRawMaterial_Callback" ClientVisible="false"
                                    ...
                                    <dx:ASPxButtonEdit ID="cmbRawMaterial1" ClientInstanceName="ClientRawMaterial1" ClientSideEvents-KeyPress="function(s,e){ e.htmlEvent.preventDefault();}"
                                        Width="100%" runat="server">
                                        <Buttons>
                                            <dx:EditButton>
                                            </dx:EditButton>
                                        ...
                                        <ClearButton DisplayMode="OnHover"></ClearButton>
                                        <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('TransRawMaterial'); }" />
                                    </dx:ASPxButtonEdit>
                           ...
                           <dx:LayoutItem Caption="Topping & Special Specification">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    ...
                                    <dx:ASPxComboBox ID="cmbTopping"  ClientInstanceName="ClientTopping" OnCallback="cmbTopping_Callback" ClientVisible="false"
                                                    ValueField="Code" runat="server" IncrementalFilteringMode="Contains" EnableSynchronization="False">
                                                    <Columns>
                                                          <dx:ListBoxColumn FieldName="Code" Width="20%"/>
                                                          <dx:ListBoxColumn FieldName="Description" />
                                    ...
                                    <dx:ASPxButtonEdit ID="cmbTopping1" ClientInstanceName="ClientTopping1" ClientSideEvents-KeyPress="function(s,e){ e.htmlEvent.preventDefault();}"
                                        Width="100%" runat="server">
                                        <Buttons>
                                            <dx:EditButton>
                                            </dx:EditButton>
                                        ...
                                        <ClearButton DisplayMode="OnHover"></ClearButton>
                                        <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('Topping'); }" />
                                    </dx:ASPxButtonEdit>
                                   </dx:LayoutItemNestedControlContainer>
                               </LayoutItemNestedControlCollection>
                           </dx:LayoutItem>
                           <dx:LayoutItem Caption="Size & Media & Net weight" Width="100%" VerticalAlign="Middle">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <%--<dx:aspxbuttonedit id="cmbSizeMedia" clientinstancename="ClientSizeMedia" readonly="true"   
                                    width="100%" runat="server">
                                        <buttons>
                                            <dx:editbutton>
                                            </dx:editbutton>
                                    ...
                                    <dx:ASPxComboBox ID="cmbSizeMedia" OnCallback="cmbSizeMedia_Callback" ClientInstanceName="ClientSizeMedia" ClientVisible="false"
                                                    ValueField="Code" runat="server" IncrementalFilteringMode="Contains" EnableSynchronization="False">
                                                    <Columns>
                                                        <dx:ListBoxColumn FieldName="Code" Width="20%"/>
                                    ...
                                    <dx:ASPxButtonEdit ID="cmbSizeMedia1" ClientInstanceName="ClientSizeMedia1" ClientSideEvents-KeyPress="function(s,e){ e.htmlEvent.preventDefault();}"
                                        Width="100%" runat="server">
                                        <Buttons>
                                            <dx:EditButton>
                                            </dx:EditButton>
                                        ...
                                        <ClearButton DisplayMode="OnHover"></ClearButton>
                                        <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('SizeMedia'); }" />
                                    </dx:ASPxButtonEdit>
                                   </dx:LayoutItemNestedControlContainer>
                               </LayoutItemNestedControlCollection>
                           </dx:LayoutItem>
                        <dx:LayoutItem Caption="Container & Lid Type" VerticalAlign="Middle" Width="100%">
                            <SpanRules>
                               ...
                               <LayoutItemNestedControlCollection>
                                   <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                       <dx:ASPxComboBox ID="CmbContainerLid" runat="server" ClientInstanceName="ClientContainerLid" ValueField="Code" ClientVisible="false"   
                                       ...
                                       <%--ClientSideEvents-KeyPress="function(s,e){ e.htmlEvent.preventDefault();}"--%>
                                       <dx:ASPxButtonEdit ID="CmbContainerLid1" ClientInstanceName="ClientContainerLid1"
                                        Width="100%" runat="server">
                                            <Buttons>
                                                <dx:EditButton>
                                                </dx:EditButton>
                                           ...
                                           <ClearButton DisplayMode="OnHover"></ClearButton>
                                        <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('ContainerLid'); }" />
                                    </dx:ASPxButtonEdit>
                                   </dx:LayoutItemNestedControlContainer>
                               </LayoutItemNestedControlCollection>
                           </dx:LayoutItem> 
                           <dx:LayoutItem Caption="Zone or Country Group">
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbGrade" ValueField="Code" OnCallback="cmbGrade_Callback" ClientVisible="false"
                                    ...
                                    <dx:ASPxButtonEdit ID="cmbGrade1" ClientInstanceName="ClientGrade1" ClientSideEvents-KeyPress="function(s,e){ e.htmlEvent.preventDefault();}"
                                        Width="100%" runat="server">
                                        <Buttons>
                                            <dx:EditButton>
                                            </dx:EditButton>
                                        ...
                                        <ClearButton DisplayMode="OnHover"></ClearButton>
                                        <ClientSideEvents ButtonClick="function(s, e) { OnButtonClick('Grade'); }" />
                                    </dx:ASPxButtonEdit>
                                   </dx:LayoutItemNestedControlContainer>
                               </LayoutItemNestedControlCollection>
                           </dx:LayoutItem>
    ...
    <asp:SqlDataSource ID="dsgv" runat="server" ConnectionString="<%$ ConnectionStrings:CostingConnectionString %>"
        SelectCommand="spGetRequestForm" SelectCommandType="StoredProcedure" OnSelecting="dsgv_Selecting">
        <SelectParameters>
...
<%--        <SelectParameters>
    ...
    <asp:SqlDataSource ID="dsComponent" runat="server" ConnectionString="<%$ ConnectionStrings:CostingConnectionString %>"
        SelectCommand="spGetCompoEditForm" SelectCommandType="StoredProcedure"  OnSelecting="dsComponent_Selecting">
       <SelectParameters>
