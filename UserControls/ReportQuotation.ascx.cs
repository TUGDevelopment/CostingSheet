...
public partial class UserControls_TechnicalReport : MasterUserControl
{
    ...
    protected void gridData_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        ...
        if (args[0] == "filter")
        {
            ...
            SqlParameter[] param = { new SqlParameter("@from", args[1]),
            new SqlParameter("@to", args[2]),
            new SqlParameter("@material", args[3]),
            new SqlParameter("@Costing", args[4].ToString()),
            new SqlParameter("@requestno", args[5].ToString()),
            new SqlParameter("@statusapp", args[6].ToString()),
            new SqlParameter("@UserNo", user_name.ToString())};
            MyTable = cs.GetRelatedResources("spSummaryQuotation", param);
    ...
    void CreateGridColumns(DataView view)
    {
        ...
        var values = new[] { "Received", "Started","Completed", "CreateOn", "SendMKT", "R&D","SendCostMKT", "Marketing","Form","To", "ActionDate" };
        ...
        foreach (DataColumn c in table.Columns)
        {
            ...
            if (c.ColumnName.Equals("MarketingName") || c.ColumnName.Equals("By"))
            {
            ...
            else if (c.ColumnName.Equals("CD") || c.ColumnName.Equals("PMC")|| c.ColumnName.Equals("Name") || c.ColumnName.Equals("Requester")) {
            ...
            else if (c.ColumnName.Equals("Customer") || c.ColumnName.Equals("ShipTo"))
            {
            ...
            else if(values.Any(c.ColumnName.Equals))
            {
            ...
            else if (dataname.Any(c.ColumnName.Equals))
            {
