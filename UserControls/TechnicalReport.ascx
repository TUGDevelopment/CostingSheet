<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TechnicalReport.ascx.cs" Inherits="UserControls_TechnicalReport" %>
<script type="text/javascript">
        ...
        function ShowWindowByName(key,name) {
            ...
            //debugger;
            var url = 'UserControls/MSCharts.aspx?view=4&id=222';
    ...
    <ContentCollection>
        ...
        <dx:ASPxFilterControl ID="filter" runat="server" 
            ...
            <Columns>
                ...
                <dx:FilterControlTextColumn ColumnType="String" PropertyName="MarketingNumber" DisplayName="CostingNo" />
		        <dx:FilterControlTextColumn ColumnType="String" PropertyName="Code" DisplayName="Material" />
