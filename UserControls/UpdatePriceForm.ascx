<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UpdatePriceForm.ascx.cs" Inherits="UserControls_UploadcostForm" %>
<script type="text/javascript">
    ...
    function OnButtonClick(evt) {
        ...
        if (evt == "CostingSheet")
            url = 'popupControls/selmaster.aspx?view=' + evt + "&Company=" + ClientCompanyEdit.GetValue() + "&type=1";
    ...
    function HidePopupAndShowInfo(closedBy, returnValue) {
        ...
        if (closedBy == "CostingSheet") {
            ...
            ClientintGrid.GetValuesOnCustomCallback("CostingSheet|" + returnValue + "|" + curentEditingIndex, function (r) {
                if (!r)
                    return;
                g.SetCellValue(curentEditingIndex, "Code", r["Code"]);
...
<dx:ASPxGridView runat="server" ID="gridData" KeyFieldName="ID;RequestType;StatusApp;UserType" DataSourceID="dsgv" ClientInstanceName="ClientgridData" Width="100%"  
	...
	<ClientSideEvents Init="Demo.Init" />
        <PanelCollection>
            ...
            <Items>
                <dx:LayoutGroup Caption="Marketing to update costing sheet" ColCount="4" GroupBoxDecoration="HeadingLine"
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Request Date" VerticalAlign="Middle" ClientVisible="false">
                            <SpanRules>
                                <dx:SpanRule ColumnSpan="1" RowSpan="1" BreakpointName="S"></dx:SpanRule>
                                <dx:SpanRule ColumnSpan="1" RowSpan="1" BreakpointName="M"></dx:SpanRule>
                            </SpanRules>
                            ...
                            <SpanRules>
                               ...
                               <LayoutItemNestedControlCollection>
                                   <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                       <dx:ASPxComboBox ID="CmbCustomPriceEdit" runat="server" DataSourceID="dsCustomerPrice" TextField="Name" ValueField="ID" 
                        ...
                        <dx:LayoutItem Caption="" Width="100%">
                            ...
                            <LayoutItemNestedControlCollection>
                                ...
                                <dx:ASPxGridView ID="Grid" ClientInstanceName="ClientintGrid" runat="server" Width="100%"   
                                    OnDataBinding="Grid_DataBinding" AutoGenerateColumns="false" KeyFieldName="ID" OnDataBound="Grid_DataBound"
                                    OnCustomCallback="Grid_CustomCallback" OnHtmlDataCellPrepared="Grid_HtmlDataCellPrepared"
                                    OnCustomDataCallback="Grid_CustomDataCallback"
                                    OnBatchUpdate="Grid_BatchUpdate" OnCustomButtonInitialize="Grid_CustomButtonInitialize"
                                    ...
                                    <Columns>
                                        <dx:GridViewDataColumn FieldName="RowID" Caption="Row" EditFormSettings-Visible="False" Width="5%"/>
                                        <dx:GridViewDataTextColumn FieldName="Code" Caption="Material" Name="Code" Width="20%"/>
                                        <dx:GridViewBandColumn Caption="Costing Sheet">
                                            <Columns>
                                                <dx:GridViewDataButtonEditColumn FieldName="CostingSheet" Caption="Current" Name="CostingSheet">
                                                ...
                                                <dx:GridViewDataColumn FieldName="Result" EditFormSettings-Visible="False" Caption="New"/>
                                            </Columns>
                                        </dx:GridViewBandColumn>
                                        <dx:GridViewDataTextColumn FieldName="VarietyPack" Width="15%"/>
                                        <dx:GridViewDataTextColumn FieldName="SellingUnit" Caption="Quantity/ Selling Unit" />
                                        <dx:GridViewDataTextColumn FieldName="Units" Caption="Selling Unit/ Carton" />
                                        <dx:GridViewDataTextColumn FieldName="TotalPack" Caption="Total Pack/ Carton" />
                                        <dx:GridViewDataTextColumn FieldName="PackingStyle" />
					                    <dx:GridViewDataColumn FieldName="StatusApp" Caption="Status"/>
                                        <dx:GridViewDataColumn FieldName="Mark" Visible="false"/>
                                        <dx:GridViewDataColumn FieldName="Series" Visible="false"/>
					                    <dx:GridViewDataColumn FieldName="SiteId" Visible="false"/>
                                    </Columns>
                                    <SettingsSearchPanel ColumnNames="" Visible="false" />
                                    ...
                                    <ClientSideEvents 
                                        ...
                                        }}" BatchEditEndEditing="OnBatchEditEndEditing" BatchEditStartEditing="OnBatchEditStartEditing" EndCallback="Demo.CostingSheet"/>
                                </dx:ASPxGridView>
    ...
    <asp:SqlDataSource ID="dsresult" runat="server" ConnectionString="<%$ ConnectionStrings:CostingConnectionString %>"
        SelectCommand="spGetEditCosting" SelectCommandType="StoredProcedure">
        <SelectParameters>
