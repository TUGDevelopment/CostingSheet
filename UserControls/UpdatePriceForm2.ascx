<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UpdatePriceForm2.ascx.cs" Inherits="UserControls_UploadcostForm" %>
...
<dx:ASPxGridView runat="server" ID="gridData" KeyFieldName="ID;RequestType;StatusApp;UserType" DataSourceID="dsgv" ClientInstanceName="ClientgridData" Width="100%"  
        ...
        <dx:GridViewDataTextColumn FieldName="Company" Caption="Plant" VisibleIndex="3">
            <PropertiesTextEdit >
            ...
            <Items>
                <dx:LayoutGroup Caption="Marketing to update costing sheet" ColCount="4" GroupBoxDecoration="HeadingLine"
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Company Code" VerticalAlign="Middle" Name="ProductCategory">
                            <SpanRules>
                                <dx:SpanRule ColumnSpan="1" RowSpan="1" BreakpointName="S"></dx:SpanRule>
                                <dx:SpanRule ColumnSpan="1" RowSpan="1" BreakpointName="M"></dx:SpanRule>
                            </SpanRules>
				    ...
				    <Toolbars>
                                    ...
                                    <Columns>
                                        <dx:GridViewDataColumn FieldName="RowID" Caption="Row" EditFormSettings-Visible="False" Width="40px"/>
                                        <dx:GridViewDataTextColumn FieldName="Code" Caption="Material" Name="Code"/>
                                        <dx:GridViewBandColumn Caption="Costing Sheet">
                                            <Columns>
                                                <dx:GridViewDataButtonEditColumn FieldName="CostingSheet" Caption="Current" Name="CostingSheet" Width="142px">
                                                ...
                                                <dx:GridViewDataColumn FieldName="Result" EditFormSettings-Visible="False" Caption="New" Width="142px"/>
                                            </Columns>
                                        </dx:GridViewBandColumn>
                                        <dx:GridViewDataColumn FieldName="Series">              
					                    ...
					                    <dx:GridViewDataColumn FieldName="SiteId">              
                                            <HeaderStyle CssClass="hide" />
                                            <EditCellStyle CssClass="hide" />
                                            <CellStyle CssClass="hide" />
                                            <FilterCellStyle CssClass="hide" />
					                    ...
					                    <dx:GridViewDataColumn FieldName="StatusApp" Width="42px" Caption="Status"/>
                                        <dx:GridViewDataColumn FieldName="Mark" Width="42px" HeaderStyle-CssClass="unitPriceColumn" CellStyle-CssClass="unitPriceColumn"/>
                                    </Columns>
                                    <SettingsSearchPanel ColumnNames="" Visible="false" />
