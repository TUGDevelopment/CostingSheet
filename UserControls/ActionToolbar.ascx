...
<td class="Strut">
    <div style="float: left">
        <dx:ASPxImage ID="ExpandPaneImage" runat="server" Cursor="pointer" SpriteCssClass="Sprite_ExpandPane" ToolTip="Expand" AlternateText="Expand" 
            ...
            <ClientSideEvents Click="Demo.ClientExpandPaneImage_Click" />
        </dx:ASPxImage>
    </div>
    <div style="float: left">
        <dx:ASPxMenu ID="ActionMenu" runat="server" DataSourceID="ActionMenuDataSource"
            ...
            <ClientSideEvents ItemClick="Demo.ClientActionMenu_ItemClick" />
    ...
    <div style="float:right">
        <dx:ASPxMenu ID="InfoMenu" runat="server" DataSourceID="InfoMenuDataSource" ClientInstanceName="ClientInfoMenu" 
            ...
            <ClientSideEvents ItemClick="Demo.ClientInfoMenu_ItemClick" />
            <Border BorderWidth="0" />
            <SubMenuStyle CssClass="SubMenu" />
        </dx:ASPxMenu>
    </div>
...
<td>
    <dx:ASPxButtonEdit runat="server" ID="SearchBox" Width="220" Height="31" NullText="Type to Search..." CssClass="SearchBox" 
        ...
        <ClientSideEvents 
            TextChanged="Demo.ClientSearchBox_TextChanged" 
            KeyDown="Demo.ClientSearchBox_KeyDown"
            KeyPress="Demo.ClientSearchBox_KeyPress"
        />
        <Buttons>
            <dx:EditButton>
                <Image>
