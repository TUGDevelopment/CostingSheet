...
<table class="NavigationToolbar"><tr><td>
    <dx:ASPxMenu ID="NavigationMenu" runat="server" CssClass="NavigationMenu" ToolTip="Menu" OnInit="NavigationMenu_Init" 
        ClientInstanceName="NavigationMenu" 
    ...
    <dx:ASPxImage ID="CollapsePaneImage" runat="server" Cursor="pointer" SpriteCssClass="Sprite_CollapsePane" ToolTip="Collapse" AlternateText="Collapse" 
        ...
        <ClientSideEvents Click="Demo.ClientCollapsePaneImage_Click" />
    </dx:ASPxImage>
</td></tr></table>
